...
InMethod.Drag.prototype = {	
	...
	onMouseMove: function(e) {
		...
		if (e.clientX < 0 || e.clientY < 0) { return; } //should this be null or false?

		var deltaX = e.clientX - this.lastMouseX;
		var deltaY = e.clientY - this.lastMouseY;
				
		var res = this.onDrag.bind(this.thisRef)(Wicket.$(this.elementId),
                                             deltaX, deltaY, e);
...
//reduce undefined errors on strict error checking
Element.prototype =
{
   imxtInitialized: false,
   imxtPrelightAttached: false
};
...
InMethod.XTable.prototype = {
	...
	getElements: function(tagName, className, root)
  {
    ...
    {
			var c = columns[i];			
			if ( !hasClass(c, "imxt-padding")
        && c.imxtReorderable == true && c.imxtAttached != true)
      {
				new InMethod.Drag(c, this.columnDragBegin, this.columnDragEnd,
                          this.columnDrag, this);
				c.imxtAttached = true;
			}
		}
