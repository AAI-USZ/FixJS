function (input, output, symmetricKey, iv, operation) {
    ...
    try {
      ...
      for(var __x in slot.contents) {
        this.log("slot["+__x+"]="+slot.contents[__x]);
      }
      this.log("TokenName: " + this.nss.PK11_GetTokenName(slot).readString());
      //this.log("slot.isHW: " + slot.isInternal);
      if (slot.isNull())
