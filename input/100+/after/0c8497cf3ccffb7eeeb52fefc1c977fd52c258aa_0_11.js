function() {
  ...
  this.Node = Node = (function() {
    ...
    Node.prototype.envEnrichments = function() {
      ...
      return nub(concatMap(this.childNodes, function(child) {
        var _ref1, _ref2;
        return (_ref1 = (_ref2 = _this[child]) != null ? _ref2.envEnrichments() : void 0) != null ? _ref1 : [];
      }));
    };
    ...
    Node.prototype.usedAsExpression = function(ancestors) {
      var _ref1;
      switch (false) {
  ...
  this.ForIn = ForIn = (function(_super) {
    ...
    ForIn.prototype.envEnrichments = function() {
      return nub(concat([ForIn.__super__.envEnrichments.apply(this, arguments), beingDeclared(this.valAssignee), this.keyAssignee != null ? beingDeclared(this.keyAssignee) : []]));
    };
  ...
  this.ForOf = ForOf = (function(_super) {
    ...
    ForOf.prototype.envEnrichments = function() {
      return nub(concat([ForOf.__super__.envEnrichments.apply(this, arguments), beingDeclared(this.keyAssignee), this.valAssignee != null ? beingDeclared(this.valAssignee) : []]));
    };
  ...
  this.GenSym = GenSym = (function(_super) {
