function init(){
			...
			html.push("<div id='console_"+pf+"' style='width:"+canvas_width+"px; height: 0px; float:left; overflow-y:scroll;'><div id='console_entries_"+pf+"' style='padding-top: 25px;'></div></div>");
