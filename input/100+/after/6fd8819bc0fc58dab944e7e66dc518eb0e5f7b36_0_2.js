function() {
  ...
  a++;
  __coverage_data['Class.js__from_6_13_to_6_28'][42]++;
  c.a++;
  ...
  __coverage_data['Class.js__from_6_13_to_6_28'][47]++;
  this.b = "q \" we";
}, butThisOneDoes: function() {
  __coverage_data['Class.js__from_6_13_to_6_28'][51]++;
  a++;
}, andThisOneButItsUgly: function() {
  __coverage_data['Class.js__from_6_13_to_6_28'][54]++;
  a++;
}, andThisOneButItsEmpty: function() {
}};
  __coverage_data['Class.js__from_6_13_to_6_28'][59]++;
  var e = function() {
  __coverage_data['Class.js__from_6_13_to_6_28'][60]++;
  this.e = "aaaaa";
};
  ...
  __coverage_data['Class.js__from_6_13_to_6_28'][67]++;
  var m1 = {}, m2 = null, m3 = 'asd', m4 = 'qwe';
  __coverage_data['Class.js__from_6_13_to_6_28'][72]++;
  if (param) {
  ...
  __coverage_data['Class.js__from_6_13_to_6_28'][77]++;
  if (!param) {
  ...
  __coverage_data['Class.js__from_6_13_to_6_28'][82]++;
  while (true === false) {
  ...
  var s = 1;
  __coverage_data['Class.js__from_6_13_to_6_28'][87]++;
  while (++s < 10) {
    __coverage_data['Class.js__from_6_13_to_6_28'][88]++;
    s++;
  }
  __coverage_data['Class.js__from_6_13_to_6_28'][90]++;
  for (var j = 0; j < 20; j++) {
...
do {
  ...
  if (param === true) 
  {
    ...
    if (typeof param === 'boolean') 
    {
      ...
      if (param !== undefined) 
      {
        ...
        __coverage_data['Class.js__from_6_13_to_6_28'][115]++;
        a = 'kkk';
      }
    }
  }
  ...
  if (param) 
  {
    ...
    __coverage_data['Class.js__from_6_13_to_6_28'][121]++;
    a++;
  }
}, a: 123};
  ...
  if (false) 
  {
    ...
    z++;
    __coverage_data['Class.js__from_6_13_to_6_28'][134]++;
    a++;
    __coverage_data['Class.js__from_6_13_to_6_28'][135]++;
    b++;
    __coverage_data['Class.js__from_6_13_to_6_28'][137]++;
    var h = 'qwe';
  }
...
do {
  ...
  __coverage_data['Class.js__from_6_13_to_6_28'][176]++;
  b++;
}
  ...
  if (param) 
  {
    ...
    __coverage_data['Class.js__from_6_13_to_6_28'][182]++;
  ...
  __coverage_data['Class.js__from_6_13_to_6_28'][210]++;
  try {
    __coverage_data['Class.js__from_6_13_to_6_28'][211]++;
    if (mynamespace) {
    }
  }  catch (ex) {
  __coverage_data['Class.js__from_6_13_to_6_28'][213]++;
