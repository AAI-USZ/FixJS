function(keyword) {
      var _base, _base1, _base2, _name, _name1, _name2, _ref, _ref1, _ref2, _ref3;
      ...
      if (PCAXIS_KEYWORDS[keyword.name][LANGUAGE]) {
        if ((_ref = keyword.language) == null) {
          keyword.language = this.lang;
        }
      }
      if ((_ref1 = (_base = this.keywords)[_name = keyword.name]) == null) {
        _base[_name] = [];
      }
      this.keywords[keyword.name].push(keyword);
      if (keyword.variable != null) {
        if ((_ref2 = (_base1 = this.variables)[_name1 = keyword.variable]) == null) {
          _base1[_name1] = {};
        }
        if ((_ref3 = (_base2 = this.variables[keyword.variable])[_name2 = keyword.name]) == null) {
          _base2[_name2] = [];
        }
