function() {
    ...
    talk: function() {
      ...
      if (jQuery.browser.msie) {
        return document.playera.attachEvent("EndOfStream", function(state) {
          var _ref1;
          return (_ref1 = _this.dialog) != null ? _ref1.dialog("close") : void 0;
        });
      } else {
  ...
  jQuery.widget("Capkom.sizedetect", {
    ...
    _create: function() {
      ...
      this.details = {};
      this.moveTimer = new StopWatch(this.console.error);
      this.reactionTimer = new StopWatch(this.console.error);
