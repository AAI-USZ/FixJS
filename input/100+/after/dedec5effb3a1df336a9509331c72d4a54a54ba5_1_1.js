function() {
  ...
  describe("create", function() {
    describe("with src", function() {
      ...
      it("should set result", function() { expect(result).toBeEqualish([1, 2, 3, 4, 5, 6]); });
  ...
  describe("inverse", function() {
    ...
    describe("with dest", function() {
      beforeEach(function() { result = mat2d.inverse(a = [4, 7, 2, 6, 1, 3], dest); });
      it("should set dest", function() { expect(dest).toBeEqualish([0.6, -0.7, -0.2, 0.4, 0, -0.5]); });
      it("should return dest", function() { expect(result).toBe(dest); });
      it("should not modify a", function() { expect(a).toBeEqualish([4, 7, 2, 6, 1, 3]); });
    });
    
    describe("without dest", function() {
      beforeEach(function() { result = mat2d.inverse(a = [4, 7, 2, 6, 1, 3]); });
      it("should set a", function() { expect(a).toBeEqualish([0.6, -0.7, -0.2, 0.4, 0, -0.5]); });
  ...
  describe("multiply", function() {
    describe("with dest", function() {
      ...
      it("should set dest", function() { expect(dest).toBeEqualish([25, 28, 57, 64, 100, 112]); });
      it("should return dest", function() { expect(result).toBe(dest); });
      it("should not modify a", function() { expect(a).toBeEqualish([1, 2, 3, 4, 5, 6]); });
      it("should not modify b", function() { expect(b).toBeEqualish([7, 8, 9, 10, 11, 12]); });
    });
    
    describe("without dest", function() {
      beforeEach(function() { result = mat2d.multiply(a, b); });
      it("should set a", function() { expect(a).toBeEqualish([25, 28, 57, 64, 100, 112]); });
      it("should not change b", function() { expect(b).toBeEqualish([7, 8, 9, 10, 11, 12]); });
      it("should return a", function() { expect(result).toBe(a); });
    });
  });
  ...
  describe("scale", function() {
    ...
    describe("with dest", function() {
      ...
      it("should set dest", function() { expect(dest).toBeEqualish([2, 4, 6, 8, 10, 12]); });
      it("should return dest", function() { expect(result).toBe(dest); });
      it("should not modify a", function() { expect(a).toBeEqualish([1, 2, 3, 4, 5, 6]); });
    ...
    describe("without dest", function() {
      ...
      it("should set a", function() { expect(a).toBeEqualish([2, 4, 6, 8, 10, 12]); });
      it("should return a", function() { expect(result).toBe(a); });
      it("should not modify b", function() { expect(b).toBeEqualish([2, 2]); });
    });
  });
  ...
  describe("str", function() {
    it("should produce pretty string", function() { expect(mat2d.str(a)).toEqual("[1, 2, 3, 4, 5, 6]"); });
  });
}