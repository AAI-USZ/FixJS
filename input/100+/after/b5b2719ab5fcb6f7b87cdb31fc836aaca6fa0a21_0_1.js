function(){
	var testResourceRe = /\/tests\//,
		...
		excludes = [
			...
			"storage",
			"sql",
			"widget/(AnalogGauge|AutoRotator|BarGauge|DataPresentation|DocTester|DynamicTooltip|FeedPortlet|FilePicker|FisheyeList|gauge|Iterator|Loader|Pager|Portlet|RollingList|Rotator|rotator|SortList)",
			"wire",
			"xmpp"
		],
