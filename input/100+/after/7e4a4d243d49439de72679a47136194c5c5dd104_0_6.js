f      var parseFunctions = {
      ...
      function parse_assignmentOp() {
            ...
            if (r5 !== null) {
              ...
              if (r6 !== null) {
                ...
                if (r7 !== null) {
                  ...
                  if (r8 !== null) {
                    r8 = (function(offset, line, column, e) { return {raw: e.raw, expr: e} })(r9.offset, r9.line, r9.column, r8);
                  }
                  if (r8 === null) {
                    pos = clone(r9);
                  }
                  if (r8 === null) {
                    ...
                    if (r8 !== null) {
                      r8 = (function(offset, line, column, t, e, d) { return {raw: t + e.raw + d, expr: e} })(r9.offset, r9.line, r9.column, r11, r12, r13);
                    }
                    if (r8 === null) {
                      pos = clone(r9);
                    }
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, left, ws0, ws1, right) {
              ...
              })(r1.offset, r1.line, r1.column, r3, r4, r7, r8);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_logicalAndExpression() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, left, rights) {
              ...
              return foldl(function(expr, right){
                var raw = left.raw + right[0] + right[1] + right[3] + right[4] + right[5].raw;
                return new Nodes.LogicalAndOp(expr, right[5]).r(raw).p(line, column);
              }, left, rights);
            })(r1.offset, r1.line, r1.column, r3, r4);
        }
        if (r0 === null) {
            ...
            if (r8 !== null) {
              ...
              if (r9 !== null) {
                ...
                if (r10 !== null) {
                  ...
                  if (r11 === null) {
                    r11 = parse_bitwiseXorExpression();
                  }
                  if (r11 !== null) {
                    r5 = [r7, r8, r9, r10, r11];
                  } else {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, left, rights) {
              ...
              return foldl(function(expr, right){
                ...
                return new Nodes.BitOrOp(expr, right[4]).r(raw).p(line, column);
              }, left, rights);
            })(r1.offset, r1.line, r1.column, r3, r4);
        }
        if (r0 === null) {
      ...
      function parse_bitwiseXorExpression() {
            ...
            if (r8 !== null) {
              ...
              if (r9 !== null) {
                ...
                if (r10 !== null) {
                  r11 = parse_functionLiteral();
                  if (r11 === null) {
                    r11 = parse_bitwiseAndExpression();
                  }
                  if (r11 !== null) {
                    r5 = [r7, r8, r9, r10, r11];
                  } else {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, left, rights) {
              ...
              return foldl(function(expr, right){
                var raw = left.raw + right[0] + right[1] + right[3] + right[4].raw;
                return new Nodes.BitXorOp(expr, right[4]).r(raw).p(line, column);
              }, left, rights);
            })(r1.offset, r1.line, r1.column, r3, r4);
        }
        if (r0 === null) {
          ...
          if (r7 !== null) {
            ...
            if (r8 !== null) {
              ...
              if (r9 !== null) {
                r10 = parse_functionLiteral();
                if (r10 === null) {
                  r10 = parse_bitwiseShiftExpression();
                }
                if (r10 !== null) {
                  r5 = [r7, r8, r9, r10];
                } else {
      ...
      function parse_prefixExpression() {
        ...
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, ws, e) { return new Nodes.PreIncrementOp(e).r('++' + ws + e.raw).p(line, column); })(r1.offset, r1.line, r1.column, r4, r5);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
          if (r0 === null) {
            ...
            if (r0 !== null) {
              r0 = (function(offset, line, column, ws, e) { return new Nodes.PreDecrementOp(e).r('--' + ws + e.raw).p(line, column); })(r1.offset, r1.line, r1.column, r4, r5);
            }
            if (r0 === null) {
              pos = clone(r1);
            }
            if (r0 === null) {
              ...
              if (r0 !== null) {
                r0 = (function(offset, line, column, e) { return new Nodes.UnaryPlusOp(e).r('+' + e.raw).p(line, column); })(r1.offset, r1.line, r1.column, r4);
              }
              if (r0 === null) {
                pos = clone(r1);
              }
              if (r0 === null) {
                ...
                if (r0 !== null) {
                  r0 = (function(offset, line, column, e) { return new Nodes.UnaryNegateOp(e).r('-' + e.raw).p(line, column); })(r1.offset, r1.line, r1.column, r4);
                }
                if (r0 === null) {
                  pos = clone(r1);
                }
                if (r0 === null) {
                  ...
                  if (r0 !== null) {
                    r0 = (function(offset, line, column, o, ws, e) { return new Nodes.LogicalNotOp(e).r(o + ws + e.raw).p(line, column); })(r1.offset, r1.line, r1.column, r3, r4, r5);
                  }
                  if (r0 === null) {
                    pos = clone(r1);
                  }
                  if (r0 === null) {
                    ...
                    if (r0 !== null) {
                      r0 = (function(offset, line, column) { return new Nodes.BitNotOp(e).r('~' + ws + e.raw).p(line, column); })(r1.offset, r1.line, r1.column);
                    }
                    if (r0 === null) {
                      pos = clone(r1);
                    }
                    if (r0 === null) {
                      ...
                      if (r0 !== null) {
                        r0 = (function(offset, line, column, ws, e) { return new Nodes.DoOp(e).r('do' + ws + e.raw).p(line, column); })(r1.offset, r1.line, r1.column, r4, r5);
                      }
                      if (r0 === null) {
                        pos = clone(r1);
                      }
                      if (r0 === null) {
                        ...
                        if (r0 !== null) {
                          r0 = (function(offset, line, column, ws, e) { return new Nodes.TypeofOp(e).r('typeof' + ws + e.raw).p(line, column); })(r1.offset, r1.line, r1.column, r4, r5);
                        }
                        if (r0 === null) {
                          pos = clone(r1);
                        }
                        if (r0 === null) {
                          ...
                          if (r0 !== null) {
                            r0 = (function(offset, line, column, ws, e) { return new Nodes.DeleteOp(e).r('delete' + ws + e.raw).p(line, column); })(r1.offset, r1.line, r1.column, r4, r5);
                          }
                          if (r0 === null) {
                            pos = clone(r1);
                          }
      ...
      function parse_memberExpression() {
        ...
        if (r3 !== null) {
          ...
          if (r5 !== null) {
            r5 = (function(offset, line, column, ws, a) { return {op: a.op, operands: a.operands, raw: ws + a.raw, line: a.line, column: a.column}; })(r6.offset, r6.line, r6.column, r8, r9);
          }
          if (r5 === null) {
            pos = clone(r6);
          }
      ...
      function parse_MemberAccessOps() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, ws, e) { return {op: Nodes.MemberAccessOp, operands: [e], raw: '.' + ws + e, line: line, column: column}; })(r1.offset, r1.line, r1.column, r4, r5);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, ws, e) { return {op: Nodes.SoakedMemberAccessOp, operands: [e], raw: '?.' + ws + e, line: line, column: column}; })(r1.offset, r1.line, r1.column, r4, r5);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
          if (r0 === null) {
            ...
            if (r0 !== null) {
              r0 = (function(offset, line, column, ws0, e, ws1) { return {op: Nodes.DynamicMemberAccessOp, operands: [e], raw: '[' + ws0 + e + ws1 + ']', line: line, column: column}; })(r1.offset, r1.line, r1.column, r4, r5, r6);
            }
            if (r0 === null) {
              pos = clone(r1);
            }
            if (r0 === null) {
              ...
              if (r0 !== null) {
                r0 = (function(offset, line, column, ws0, e, ws1) { return {op: Nodes.SoakedDynamicMemberAccessOp, operands: [e], raw: '?[' + ws0 + e + ws1 + ']', line: line, column: column}; })(r1.offset, r1.line, r1.column, r4, r5, r6);
              }
              if (r0 === null) {
                pos = clone(r1);
              }
              if (r0 === null) {
                ...
                if (r0 !== null) {
                  r0 = (function(offset, line, column, ws, e) { return {op: Nodes.ProtoMemberAccessOp, operands: [e], raw: '::' + ws + e, line: line, column: column}; })(r1.offset, r1.line, r1.column, r4, r5);
                }
                if (r0 === null) {
                  pos = clone(r1);
                }
                if (r0 === null) {
                  ...
                  if (r0 !== null) {
                    r0 = (function(offset, line, column, ws0, e, ws1) { return {op: Nodes.DynamicProtoMemberAccessOp, operands: [e], raw: '::[' + ws0 + e + ws1 + ']', line: line, column: column}; })(r1.offset, r1.line, r1.column, r4, r5, r6);
                  }
                  if (r0 === null) {
                    pos = clone(r1);
                  }
                  if (r0 === null) {
                    ...
                    if (r0 !== null) {
                      r0 = (function(offset, line, column, ws, e) { return {op: Nodes.SoakedProtoMemberAccessOp, operands: [e], raw: '?::' + ws + e, line: line, column: column}; })(r1.offset, r1.line, r1.column, r4, r5);
                    }
                    if (r0 === null) {
                      pos = clone(r1);
                    }
                    if (r0 === null) {
                      ...
                      if (r0 !== null) {
                        r0 = (function(offset, line, column, ws0, e, ws1) { return {op: Nodes.SoakedDynamicProtoMemberAccessOp, operands: [e], raw: '?::[' + ws0 + e + ws1 + ']', line: line, column: column}; })(r1.offset, r1.line, r1.column, r4, r5, r6);
                      }
                      if (r0 === null) {
                        pos = clone(r1);
                      }
            ...
            if (r0 === null) {
              ...
              if (r0 === null) {
                ...
                if (r0 === null) {
                  ...
                  if (r0 !== null) {
                    r0 = (function(offset, line, column, r) { return (new Nodes.This).r(r).p(line, column); })(r1.offset, r1.line, r1.column, r0);
                  }
                  if (r0 === null) {
                    pos = clone(r1);
                  }
      ...
      function parse_switchBody() {
        ...
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, ws0, t, ws1, c) { return {cases: [[c.conditions, c.block]], raw: ws0 + t + ws1 + c.raw}; })(r1.offset, r1.line, r1.column, r3, r4, r5, r6);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
      ...
      function parse_ObjectInitialiserKeys() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, i) { return new Nodes.String(i).r(i).p(line, column); })(r1.offset, r1.line, r1.column, r0);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_bool() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, match) { return new Nodes.Bool(true).r(match).p(line, column); })(r1.offset, r1.line, r1.column, r0);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, match) { return new Nodes.Bool(false).r(match).p(line, column); })(r1.offset, r1.line, r1.column, r0);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
      ...
      function parse_Numbers() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, bs) { return new Nodes.Int(parseInt(bs.join(''), 2)).r("0b" + bs).p(line, column); })(r1.offset, r1.line, r1.column, r4);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, os) { return new Nodes.Int(parseInt(os.join(''), 8)).r("0o" + os).p(line, column); })(r1.offset, r1.line, r1.column, r4);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
          if (r0 === null) {
            ...
            if (r0 !== null) {
              r0 = (function(offset, line, column, hs) { return new Nodes.Int(parseInt(hs.join(''), 16)).r("0x" + hs).p(line, column); })(r1.offset, r1.line, r1.column, r4);
            }
            if (r0 === null) {
              pos = clone(r1);
            }
      ...
      function parse_string() {
        ...
        if (r0 === null) {
          ...
          if (r0 === null) {
            ...
            if (r0 !== null) {
              r0 = (function(offset, line, column, d) { return new Nodes.String(d ? d.join('') : '').p(line, column); })(r1.offset, r1.line, r1.column, r4);
            }
            if (r0 === null) {
              pos = clone(r1);
            }
      ...
      function parse_interpolation() {
        ...
        if (r3 !== null) {
          ...
          if (r5 !== null) {
            r5 = (function(offset, line, column, d) { return new Nodes.String(d.join('')).p(line, column); })(r6.offset, r6.line, r6.column, r5);
          }
          if (r5 === null) {
            pos = clone(r6);
          }
      ...
      function parse_regexp() {
        ...
        if (r3 !== null) {
          ...
          if (r5 !== null) {
            r5 = (function(offset, line, column) { return [new Nodes.String('').g().p(line, column)]; })(r6.offset, r6.line, r6.column);
          }
          if (r5 === null) {
            pos = clone(r6);
          }
          if (r5 === null) {
            ...
            if (r5 !== null) {
              r5 = (function(offset, line, column, s) { return [new Nodes.String(s.join('')).g().p(line, column)]; })(r6.offset, r6.line, r6.column, r5);
            }
            if (r5 === null) {
              pos = clone(r6);
            }
      ...
      function parse_regexpData() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, d) { return "[" + (d ? d.join('') : '') + "]"; })(r1.offset, r1.line, r1.column, r4);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_hereregexpData() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, d) { return [new Nodes.String("[").g().p(line, column)].concat(d || []).concat([new Nodes.String("]").g().p(line, column)]); })(r1.offset, r1.line, r1.column, r4);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, c) { return [new Nodes.String(c).g().p(line, column)]; })(r1.offset, r1.line, r1.column, r4);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
          if (r0 === null) {
            ...
            if (r0 !== null) {
              r0 = (function(offset, line, column, s) { return [new Nodes.String(s.join('')).g().p(line, column)]; })(r1.offset, r1.line, r1.column, r0);
            }
            if (r0 === null) {
              pos = clone(r1);
            }
            if (r0 === null) {
              ...
              if (r0 !== null) {
                r0 = (function(offset, line, column, c) { return [new Nodes.String(c).g().p(line, column)]; })(r1.offset, r1.line, r1.column, r3);
              }
              if (r0 === null) {
                pos = clone(r1);
              }
      ...
      function parse_continue() {
        ...
        r0 = parse_CONTINUE();
        if (r0 !== null) {
          r0 = (function(offset, line, column) { return (new Nodes.Continue).r('continue').p(line, column); })(r1.offset, r1.line, r1.column);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_break() {
        ...
        r0 = parse_BREAK();
        if (r0 !== null) {
          r0 = (function(offset, line, column) { return (new Nodes.Break).r('break').p(line, column); })(r1.offset, r1.line, r1.column);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_undefined() {
        ...
        r0 = parse_UNDEFINED();
        if (r0 !== null) {
          r0 = (function(offset, line, column) { return (new Nodes.Undefined).r('undefined').p(line, column); })(r1.offset, r1.line, r1.column);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_null() {
        ...
        r0 = parse_NULL();
        if (r0 !== null) {
          r0 = (function(offset, line, column) { return (new Nodes.Null).r('null').p(line, column); })(r1.offset, r1.line, r1.column);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_identifier() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, i) { return new Nodes.Identifier(i).r(i).p(line, column); })(r1.offset, r1.line, r1.column, r4);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_identifierStart() {
        ...
        if (r0 === null) {
          ...
          if (r0 === null) {
            ...
            if (r2 !== null) {
              r3 = parse_UnicodeEscapeSequence();
              if (r3 !== null) {
                r0 = [r2, r3];
              } else {
                r0 = null;
      ...
      function parse_UnusedJSKeywords() {
        var cacheKey = "UnusedJSKeywords@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
