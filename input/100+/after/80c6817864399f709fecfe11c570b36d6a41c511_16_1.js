function() {
      var token, _base, _base1, _base2, _ref, _ref1, _ref2;
      ...
      switch (this.symbol) {
        ...
        case VALUE:
        case VALUE_STRING:
          if ((_ref = (_base = this.keyword).value) == null) {
            _base.value = [];
          }
        ...
        case FUNCTION:
          ...
          if ((_ref1 = (_base1 = this.keyword).value) == null) {
            _base1.value = [];
          }
          this.keyword.value.push(this["function"]);
          break;
        case ARGUMENT:
          if ((_ref2 = (_base2 = this["function"]).args) == null) {
            _base2.args = [];
          }
