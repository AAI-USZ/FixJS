function() {
    ...
    this.tests = [
        ...
        {name: "CreateAndAddPhoto", timeout: 30000},
        {name: "SearchAgain", timeout: 30000},
        {name: "ShowPhotos", timeout: 30000},
        {name: "CreateSubcollection", timeout: 30000},
        {name: "ShowParent", timeout: 30000},
        {name: "ShowSubcollections", timeout: 30000},
        {name: "QueryAndDeleteAllPhotos", timeout:30000},
        {name: "QueryAndDeleteAllCollections", timeout:30000},
    ...
    this.CreateAndAddPhoto = function(testRun) {
    ...
    this.SearchAgain = function(testRun) {
        var data = {
            user_id: drillbitUserId
        };
        Cloud.PhotoCollections.search(data, function(e) {
    ...
    this.ShowPhotos = function(testRun) {
        var data = {
            collection_id: ids[1]
        };
    ...
    this.CreateSubcollection = function(testRun) {
        var data = {
            name: 'subcollection1',
    ...
    this.ShowParent = function(testRun) {
        var data = {
            collection_id: ids[0]
        };
        Cloud.PhotoCollections.show(data, function(e) {
    ...
    this.ShowSubcollections = function(testRun) {
        var data = {
            collection_id: ids[0]
        };
    ...
    this.QueryAndDeleteAllPhotos = function(testRun) {
        var photoIds = [];
    ...
    this.QueryAndDeleteAllCollections = function(testRun) {
        var collectionIds = [];
        var subIds = [];
