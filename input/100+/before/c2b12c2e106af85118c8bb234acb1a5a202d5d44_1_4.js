function(input, startRule) {
      var parseFunctions = {
        ...
        "noPathDirective": parse_noPathDirective
      };
      ...
      function parse_textNode() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, text) { return createTextNode(text.join('')); /* TODO use properly quoted text */ })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_escapedCharacter() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, c) { return escapedCharacter(c); /* TODO support \u0000 and \x00 */ })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_doubleQuotedText() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, chars) { return chars.join(''); /* TODO support single quoted text */ })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_pathDirective() {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result6 !== null) {
                    result7 = parse_directiveParameter();
                    if (result7 !== null) {
                  ...
                  if (result6 !== null) {
                    result6 = (function(offset, line, column, p) { return p; })(pos2.offset, pos2.line, pos2.column, result6[1]);
                  }
                  if (result6 === null) {
                    pos = clone(pos2);
                  }
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, name, path, params) { return createDirective(name, path, params); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[3], result0[5]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
