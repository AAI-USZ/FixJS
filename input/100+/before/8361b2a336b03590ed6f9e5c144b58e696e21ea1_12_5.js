function() {
    ...
    this.tests = [
        ...
        {name: "CreateMultipleObjects", timeout: 30000},
        {name: "ShowObject", timeout: 30000},
        {name: "UpdateObject", timeout: 30000},
        {name: "QueryOneObject", timeout: 30000},
        {name: "QueryMultipleObjects", timeout: 30000},
        {name: "DeleteAllCars", timeout: 30000},
        {name: "DeleteAllTests", timeout: 30000},
    ...
    this.QueryMultipleObjects = function(testRun) {
        var data = {
            classname: 'test',
            limit: 10,
            skip: 0,
    ...
    this.DeleteAllCars = function(testRun) {
        var carIds = [];
    ...
    this.DeleteAllTests = function(testRun) {
        var testIds = [];
