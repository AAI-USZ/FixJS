function() {
  ...
  jQuery.widget("Capkom.wordmatch", {
    ...
    _destroy: function() {
      ...
      return this.element.css(this._savedCSS);
    },
    _beginGame: function() {
    ...
    _renderNext: function() {
      ...
      if (this.sequence.length) {
        ...
        switch (this.question.type) {
          case 's2w':
            this.questionArea.html("<img class='question' src='" + this.options.rootPrefix + this.question.question + "' style='height:" + this.options.symbolSize + "px;'/>");
    ...
    finish: function() {
      ...
      return this.message("Gratuliere, fertig!", function() {
  ...
  */
  ...
  Capkom.order = ["welcome", "symbolsize", "read", "fontsize", "theme", "channels", "symbolset", "goodbye"];
  ...
  Capkom.initNav = function() {
    ...
    jQuery(".stages").tabs({
      show: function(event, ui) {
        var autoExplain, autoForward, autoGameStart, autoread, newStage, _ref10;
