function localConfig(data)
{
	...
	data.queryFormulatorUrl = "http://localhost/isearch/server/scripts/mqf.php?index=uc6" ;
	...
	data.tagServerUrl = "http://localhost/isearch/server/scripts/user.php?mode=tags&index=uc6" ;
