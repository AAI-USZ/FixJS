function() {
	...
	*/
	runtime.ueid = 0; //unique element ID
	runtime.bind = function(events, elementID, eventHandler, buf) {
	...
	/* Retrieves the proper event handler, which is encoded in a comment right
		...
		This function is more minified because UglifyJS won't minify a function
