  ...
  this.Switch = Switch = (function(_super) {
    ...
    Switch.prototype.mayHaveSideEffects = function(inScope) {
      ...
      return any([this.expr, this.elseBlock].concat(__slice.call(otherExprs)), function(e) {
        return e.mayHaveSideEffects(inScope);
      });
    };
