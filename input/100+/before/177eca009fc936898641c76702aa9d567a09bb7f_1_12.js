f      var parseFunctions = {
      ...
      function parse_conditionalBody() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ws, t, b) { return {block: b, raw: t + b.raw}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_classBody() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ws, t, b) { return {block: b, raw: ws + t + b.raw}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_switchBody() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ws, t, b) { return {cases: b.cases, 'else': b['else'], raw: ws + t + b.raw}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_functionBody() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ws, t0, b, t1) { return {block: b, raw: ws + t0 + b.raw + t1}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2], result0[3]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
