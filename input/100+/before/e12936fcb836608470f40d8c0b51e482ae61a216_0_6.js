function() {
  var Board, GrassSimulation, GrassSimulationView, Random, Simulation, chance_doer, extend, include, linear_mover, random_mover, spawner,
    __slice = [].slice,
  ...
  chance_doer = function(func, chance) {
    return function() {
      var args;
