function(popup) { 
      if (!MobDeals.Account._createPasswordHtml) {
        MobDeals.Account._createPasswordHtml = $('#create-password-popup').remove().html();
      }
      ...
      var readInput = function() { 
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            else { MobDeals.Account._authenticated(data); callback.apply(callback, [null, true]); }
          },
          dataType: 'json'
        });
